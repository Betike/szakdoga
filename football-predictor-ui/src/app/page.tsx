      ...
      <div className="max-w-5xl w-full">
        <div className="py-10 md:py-16 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Premier League<img src="/favicon.ico" alt="Premier League Logo" className="inline-block h-8 w-8 ml-2" /> Predictor 
          </h1>
          <p className="text-lg text-gray-600 mb-6 max-w-2xl mx-auto">
            Predict match outcomes using advanced <span className="font-bold">Machine Learning models</span> trained on historical Premier League data
          </p>
        ...
        <div className="py-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card>
              ...
              <CardContent>
                <p>
                  XGBoost model provides predictions with 58.59% accuracy on test data, 
                  with fast training and prediction times.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p>
                  The Random Forest model has 60% accuracy, with strong performance on home and away wins.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p>
                  Our Neural Network achieved 59.72% accuracy on the test data, with better performance on draws than the other models.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex flex-col md:flex-row gap-6 items-center">
              <div className="md:w-1/2">
                ...
                <p className="text-gray-600">
                  ...
                  and processing them to create a well-structured dataset for the models.
                </p>
              </div>
              <div className="md:w-1/2 bg-white h-40 rounded-lg flex items-center justify-center">
                <div className="w-full h-full flex items-center justify-center" dangerouslySetInnerHTML={{ __html: `
                    <svg width="240" height="160" viewBox="0 0 240 160">
                      ...
                      <line x1="75" y1="70" x2="90" y2="70" stroke="#033C73" stroke-width="2" />
                      <polygon points="90,65 90,75 95,70" fill="#033C73" />
                      ...
                      <line x1="145" y1="70" x2="160" y2="70" stroke="#033C73" stroke-width="2" />
                      <polygon points="160,65 160,75 165,70" fill="#033C73" />
            ...
            <div className="flex flex-col md:flex-row gap-6 items-center">
              <div className="md:w-1/2 md:order-2">
                ...
                <p className="text-gray-600">
                  All models are trained on historical data and evaluated on the latest seasons to ensure they perform well on future matches.
                </p>
              </div>
              <div className="md:w-1/2 md:order-1 bg-white h-40 rounded-lg flex items-center justify-center">
                <div className="w-full h-full flex items-center justify-center" dangerouslySetInnerHTML={{ __html: `
                  <svg width="240" height="160" viewBox="0 0 240 160">
                    ...
                    <line x1="80" y1="65" x2="110" y2="65" stroke="#033C73" stroke-width="2" />
                    <polygon points="90,60 90,70 95,65" fill="#033C73" />
                    ...
                    <line x1="145" y1="65" x2="170" y2="65" stroke="#033C73" stroke-width="2" />
                    <polygon points="155,60 155,70 160,65" fill="#033C73" />
              ...
              <div className="md:w-1/2 bg-white h-40 rounded-lg flex items-center justify-center">
                <div className="w-full h-full flex items-center justify-center" dangerouslySetInnerHTML={{ __html: `
                  <svg width="240" height="160" viewBox="0 0 240 160">
                    ...
                    <line x1="60" y1="75" x2="60" y2="95" stroke="#033C73" stroke-width="2" />
                    <polygon points="55,95 65,95 60,100" fill="#033C73" />
                    ...
                    <line x1="110" y1="120" x2="125" y2="120" stroke="#033C73" stroke-width="2" />
                    <polygon points="125,115 125,125 130,120" fill="#033C73" />
                    ...
                    <text x="150" y="93" font-family="Arial, sans-serif" font-size="8" fill="#032C73" font-weight="bold">Home: 44%</text>
                    ...
                    <text x="150" y="108" font-family="Arial, sans-serif" font-size="8" fill="#032C73">Draw: 34%</text>
                    ...
                    <text x="150" y="123" font-family="Arial, sans-serif" font-size="8" fill="#032C73">Away: 23%</text>
